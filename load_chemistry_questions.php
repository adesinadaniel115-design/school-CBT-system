...
$questions = [
        // --- New CSV Chemistry Questions Start ---
        [ 'question' => 'A laboratory sample believed to be pure begins to melt over a wide temperature range rather than at a fixed point. What does this observation most strongly suggest?', 'a' => 'the sample contains dissolved gases', 'b' => 'the sample is a mixture', 'c' => 'the thermometer is faulty', 'd' => 'the sample is undergoing sublimation', 'answer' => 'B', 'explanation' => 'Pure substances melt at a fixed temperature while mixtures melt over a range.' ],
        [ 'question' => 'Two colorless liquids are mixed and produce a solution whose boiling point is significantly higher than either liquid alone. What is the most reasonable explanation?', 'a' => 'a chemical reaction forming stronger intermolecular forces', 'b' => 'complete evaporation of one component', 'c' => 'decomposition of the mixture', 'd' => 'formation of a gas', 'answer' => 'A', 'explanation' => 'Stronger intermolecular attractions raise boiling point.' ],
        [ 'question' => 'A gas sample is compressed to half its original volume while temperature remains unchanged. The pressure increases proportionally. Which molecular explanation best fits this observation?', 'a' => 'molecules collide more frequently with container walls', 'b' => 'molecules gain mass', 'c' => 'molecules stop moving randomly', 'd' => 'gas molecules become larger', 'answer' => 'A', 'explanation' => 'Reducing volume increases collision frequency causing pressure increase.' ],
        [ 'question' => 'A colorless gas diffuses through a porous barrier faster than oxygen under identical conditions. Which property of the gas is most likely responsible?', 'a' => 'higher molar mass', 'b' => 'lower molar mass', 'c' => 'stronger intermolecular forces', 'd' => 'higher boiling point', 'answer' => 'B', 'explanation' => 'Lighter gases diffuse faster according to Graham’s law.' ],
        [ 'question' => 'An element forms ions with a +1 charge and reacts vigorously with water to produce an alkaline solution. Which group in the periodic table does it most likely belong to?', 'a' => 'halogens', 'b' => 'alkali metals', 'c' => 'noble gases', 'd' => 'transition metals', 'answer' => 'B', 'explanation' => 'Alkali metals form +1 ions and react with water to produce alkaline hydroxides.' ],
        [ 'question' => 'Two compounds have identical molecular formulas but different boiling points and structural arrangements. What relationship exists between them?', 'a' => 'isotopes', 'b' => 'allotropes', 'c' => 'isomers', 'd' => 'polymers', 'answer' => 'C', 'explanation' => 'Isomers share the same formula but different structures.' ],
        [ 'question' => 'During electrolysis of an aqueous solution containing Cu²⁺ ions, a reddish metal gradually coats the cathode. Which process explains this change?', 'a' => 'oxidation of copper ions', 'b' => 'reduction of copper ions', 'c' => 'precipitation by hydroxide ions', 'd' => 'decomposition of water', 'answer' => 'B', 'explanation' => 'Cu²⁺ ions gain electrons and deposit as copper metal.' ],
        [ 'question' => 'In an experiment, adding a catalyst causes a reaction to proceed faster but the final amount of product remains unchanged. What does this imply about the catalyst?', 'a' => 'it changes equilibrium position', 'b' => 'it lowers activation energy', 'c' => 'it increases product stability', 'd' => 'it alters reaction enthalpy', 'answer' => 'B', 'explanation' => 'Catalysts speed reactions by lowering activation energy without changing equilibrium.' ],
        [ 'question' => 'A reversible reaction at equilibrium is suddenly heated and more products are formed. What can be inferred about the original reaction?', 'a' => 'it was exothermic', 'b' => 'it was endothermic', 'c' => 'it was irreversible', 'd' => 'it had zero enthalpy change', 'answer' => 'B', 'explanation' => 'Heating favors the endothermic direction.' ],
        [ 'question' => 'A solution turns red litmus paper blue and conducts electricity weakly. Which conclusion best fits these observations?', 'a' => 'the solution is a weak acid', 'b' => 'the solution is a strong base', 'c' => 'the solution is a weak base', 'd' => 'the solution is neutral', 'answer' => 'C', 'explanation' => 'Weak bases partially ionize but still change litmus.' ],
        // ... (rest of Chemistry questions in same format) ...
        // --- New CSV Chemistry Questions End ---
    [

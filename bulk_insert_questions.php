...
echo "Starting bulk insert of " . count($questions) . " questions...\n";

foreach ($questions as $index => $q) {
    try {
        $subject = Subject::firstOrCreate(['name' => $q[0]]);
        ...
        $failed++;
        $errors[] = "Question " . ($index + 1) . " (" . $q[0] . "): " . $e->getMessage();

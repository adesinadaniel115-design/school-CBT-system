        ...
        <div class="card">
            ...
            <div class="info-section">
                ...
                <div class="info-value">
                    <i class="bi bi-lightning-charge-fill" style="color: #f59e0b;"></i> JAMB Mock Examination
                </div>
            </div>

            <div class="info-section">
                <div class="info-title">Selected Subjects ({{ 1 + count($selectedSubjects) }} subjects)</div>
                <div class="subjects-list">
                    ...
                    @foreach($selectedSubjects as $subject)
                        <div class="subject-item">
                            ...
                            <div class="subject-count">{{ $subjectQuestionCount }} questions</div>
                        </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="info-section">
                <div class="info-title">Total Questions</div>
                <div class="info-value">
                    <i class="bi bi-question-circle-fill" style="color: var(--primary);"></i> 
                    {{ $englishQuestionCount + ($subjectQuestionCount * count($selectedSubjects)) }} Questions
                </div>
            </div>

            <div class="info-section">
                <div class="info-title">Exam Duration</div>
                <div class="info-value">
                    <i class="bi bi-alarm-fill" style="color: var(--danger);"></i> {{ $duration }} Minutes
                </div>
            </div>

            <!-- Token Validation -->
            <form method="POST" action="{{ route('exam.confirm.jamb') }}" id="confirmForm">
                @csrf
                ...
                <div class="token-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               id="token_code" 
                               name="token_code" 
                               class="form-control @error('token_code') is-invalid @enderror" 
